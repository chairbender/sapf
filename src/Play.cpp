...
AUPlayerBackend::AUPlayerBackend(int inNumChannels, ExtAudioFileRef inXAFRef = nullptr)
...
RtPlayerBackend::RtPlayerBackend(int inNumChannels)
#ifdef _WIN32
...
int32_t RtPlayerBackend::createGraph() {
